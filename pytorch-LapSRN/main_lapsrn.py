...
parser.add_argument("--batchSize", type=int, default=8, help="training batch size")#64
parser.add_argument("--nEpochs", type=int, default=200, help="number of epochs to train for")#100
...
def main():
    ...
    train_set = DatasetFromHdf5("data/lapsrn_train.h5")
    #"data/lap_pry_x4_small.h5"
